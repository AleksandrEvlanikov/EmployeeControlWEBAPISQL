...
namespace EmployeeControlWebAPI.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(EmployeeControlWebAPIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Employees>> GetEmployees(int id)
        {
          if (_context.Employees == null)
          {
            ...
            var employees = await _context.Employees.Include(e => e.Shifts).FirstOrDefaultAsync(e => e.EmployeesId == id);
